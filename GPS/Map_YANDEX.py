...
from ISS_locate import Share_Location_ISS
...
def getMap_ISS():
    ...
    latitude,longitude = Share_Location_ISS()
    ...
    urllib.urlretrieve(url, '/home/pi/ProjetBrassard/GPS/MAP_downloads/map_ISS.jpg')   #Telechargement de l'image resultant de la requete
    #---Service---#
...
def getMapInterface():
    ...
    MAPjpg = PhotoImage(file='/home/pi/ProjetBrassard/GPS/MAP_downloads/map_ISS.jpg')       #Chargement de la MAP
